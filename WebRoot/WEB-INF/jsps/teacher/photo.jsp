...
<div align="center">
	...
	<s:iterator value="#page.list" var="photo">
		<div class="divcss5">
		    <img src="${path}/<s:property value="#photo.tpAddress"/>" width="262" height="180">
		    <span>删除</span>
		    <a href="javascript:void(0);" class="now" onclick="shanchu(<s:property value="#photo.tpId"/>)">&nbsp;</a>
		</div> 
	</s:iterator>
	<s:if test="#page.list.isEmpty()">
		<div style="background-color:#FFFFF0;border:10px solid #F7F7F7;border-style:double;">
			...
			<font color="gray">提供能证明<strong>&nbsp;优秀的你&nbsp;</strong>的图片<br>或者你喜欢的其他图片<br>或者你的生活照...<br><br></font>
			<font color="gray">总之，这里的图片很重要哦<br>极有可能决定家长们是否选择你来帮助他们的孩子！</font><br>
			<font color="gray">最多允许上传 9 张图片，图片格式只允许为 .jpg .jpeg .png！</font><br><br><br><br><br>
		</div>
	</s:if>
</div>
...
$(function()
{
	...
	{
		window.location.href = "${path}/tp_photoupload";
	});
});
function shanchu(id)
{
	...
	({
		...
		yesCallback: function () 
		{
			$.ajax
			({
			    url: "${path}/tp_detele?tphoto.tpId="+id,
			    type: "post",
