...
<div>
	<div class="personal_box" style="background-color:white;">
		...
		<div class="info_box" align="center">
			<form id="imgFrom" action="${path}/ajax_mp_upload" method="post" enctype="multipart/form-data">
				<table>
					<tr height="280px">
						<td>
				...
				<input id="id" style="display: none;" name="mphoto.UId" value="<s:property value="#session.user.UId"/>">
...
{
	var id = $("#id").val();
	window.location.href = "${path}/mp_photo?mechanism.UId="+id;
});	
</script>
</html>